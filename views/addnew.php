                ...
                <div class="col-4">
                  <div class="d-inline" id="status">
                    <div class="custom-control custom-radio d-inline">
                      ...
                      <!-- <div class="col-2"><button id="submit" class="btn btn-secondary d-inline">Submit</button><button id="back" class="btn btn-secondary d-inline">Back</button></div>     -->
                    </div>
                    <div class="mt-20">
                      <label for="">Select Category</label>
                    </div>
                    <select class="form-control custom-textbox" id="category"></select>
